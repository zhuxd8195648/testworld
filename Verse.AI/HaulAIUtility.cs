...
namespace Verse.AI
{
	public static class HaulAIUtility
	{
		...
		public static bool PawnCanAutomaticallyHaul(Pawn p, Thing t, bool forced)//棋子可以自动运输
		{
		...
		public static bool PawnCanAutomaticallyHaulFast(Pawn p, Thing t, bool forced)//棋子可以自动快速运输
		{
		...
		public static Job HaulToStorageJob(Pawn p, Thing t)//运输至储存工作
		{
		...
		public static Job HaulToCellStorageJob(Pawn p, Thing t, IntVec3 storeCell, bool fitInStoreCell)//运输至单元格储存工作
		{
		...
		public static Job HaulToContainerJob(Pawn p, Thing t, Thing container)//运输至容器工作
		{
		...
		public static bool CanHaulAside(Pawn p, Thing t, out IntVec3 storeCell)//可以运输到一边
		{
		...
		public static Job HaulAsideJobFor(Pawn p, Thing t)//把东西运输到一边
		{

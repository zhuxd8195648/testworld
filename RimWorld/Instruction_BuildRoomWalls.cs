	...
	public class Instruction_BuildRoomWalls : Lesson_Instruction
	{
		...
		protected override float ProgressPercent
		{
			get
			{
				...
				{
					if (TutorUtility.BuildingOrBlueprintOrFrameCenter已存在(edgeCell, base.Map, ThingDefOf.Wall))
					{
						num2++;
					}
					num++;
		...
		public override void LessonUpdate()
		{
			...
			cachedEdgeCells.AddRange(RoomRect.EdgeCells.Where((IntVec3 c) => !TutorUtility.BuildingOrBlueprintOrFrameCenter已存在(c, base.Map, ThingDefOf.Wall)).ToList());

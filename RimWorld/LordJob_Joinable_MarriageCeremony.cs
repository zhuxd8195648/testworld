...
namespace RimWorld
{
	public class LordJob_Joinable_MarriageCeremony : LordJob_VoluntarilyJoinable
	{
		...
		public override StateGraph CreateGraph()
		{
			...
			transition2.AddTrigger(new Trigger_TickCondition(() => firstPawn.relations.DirectRelation已存在(PawnRelationDefOf.Spouse, secondPawn)));
		...
		private bool ShouldCeremonyBeCalledOff()
		{
			...
			if (!firstPawn.relations.DirectRelation已存在(PawnRelationDefOf.Fiance, secondPawn))
			{
				return true;
			}

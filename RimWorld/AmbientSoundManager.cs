...
namespace RimWorld
{
	public static class AmbientSoundManager
	{
		...
		private static bool WorldAmbientSoundCreated => Find.SoundRoot.sustainerManager.Sustainer已存在(SoundDefOf.Ambient_Space);

		private static bool AltitudeWindSoundCreated => Find.SoundRoot.sustainerManager.Sustainer已存在(SoundDefOf.Ambient_AltitudeWind);
